...
const findAll = async (req, res) => {
    ...
    try {
        ...
        const allGradesNormalize = allGrades.map((grade) => {
            return { id: grade._id, ...grade.toJSON() };
        });

        res.send(allGradesNormalize);
...
const findOne = async (req, res) => {
    ...
    try {
        ...
        res.send({ id: grade._id, ...grade.toJSON() });
...
const removeAll = async (req, res) => {
    try {
        ...
        res.send({ message: 'Todos os grades excluidos com sucesso' });
